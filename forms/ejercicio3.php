...
<input type="radio" name="sumar" value="Sumar">
<label for="sumar">Sumar</label>
<br>
<input type="radio" name="restar" value="Restar">
<label for="restar">Restar</label>
<br>
<input type="radio" name="multiplicar" value="Multiplicar">
<label for="multiplicar">Multiplicar</label>
<br>
<input type="radio" name="dividir" value="Dividir">
